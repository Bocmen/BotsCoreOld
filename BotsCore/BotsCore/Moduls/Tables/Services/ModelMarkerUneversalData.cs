...
namespace BotsCore.Moduls.Tables.Services
{
    ...
    public class ModelMarkerUneversalData<T> : ModelMarkerTable
    {
        ...
        public ModelMarkerUneversalData<T> GetElemNewId(uint id) => propTable != null ? new ModelMarkerUneversalData<T>(propTable, id) : new ModelMarkerUneversalData<T>(appName, tableName, id);
